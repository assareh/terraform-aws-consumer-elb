...
variable "environment" {
  description = "The environment this will be deployed into.  examples: dev, stage, prod | [more info:](https://github.com/mocofound/terraform-aws-consumer-elb/edit/master/readme.md)"
}
